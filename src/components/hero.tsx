  ...
  return (
    <>
      <div className='flex flex-row'>
        <a
          href='https://github.com/adailsonaguiar'
          target='_blank'
          rel='noopener noreferrer'
          className='rounded-full'
        >
          <Avatar className='size-28 shadow border'>
            <AvatarImage alt={avatar.name} src={'https://media.licdn.com/dms/image/v2/D4D03AQEodQSdzGdaKA/profile-displayphoto-shrink_800_800/profile-displayphoto-shrink_800_800/0/1724091231409?e=1732147200&v=beta&t=8qcZGX6_0U9YvNEt9t_7ZsiWX0DMoyDhXHyczZ1eDTo'} />
      ...
      <div className='flex items-center flex-row gap-4'>
        ...
        >
          <a
            href='https://linkedin.com/in/adailsonaguiar'
            target='_blank'
            rel='noopener noreferrer'
